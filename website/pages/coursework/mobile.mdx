...
description: In recent years, mobile cloud computing has been one of the hottest topics regarding technological advancement. So what exactly is mobile cloud computing, and why has it gotten so much attention?
---
...
![Server - Client - Database](./mobile/img/structure1.png)
...
![image](./mobile/img/structure2.png)
...
<Callout type="tip" emoji="💡">
  ...
  schema](https://dev.mysql.com/doc/workbench/en/wb-importing-sql-script.html).
...
![iOS Homescreen](./mobile/img/homescreen-ios14.png)

![Android Homescreen](./mobile/img/homescreen-android-lollipop.png)
...
**Milestone 12:** Justify your choice of framework/library by comparing it against others. Explain why the one you have chosen best fulfills your needs. Lastly, list down some (at least 5) of the mobile site design principles and which pages/screens demonstrate them.
...
The final submission is due <FormattedDate date={assignments.mobile.submission}/>.
