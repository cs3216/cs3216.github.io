...
{assignments.product_design.show_updating_notice && <Callout type="warning" emoji="⚠️"> The final project write-up is currently being updated. Details are tentative and will be finalised soon.</Callout>}
