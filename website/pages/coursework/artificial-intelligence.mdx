...
| Vicuna-13B | [GitHub](https://github.com/lm-sys/FastChat), [Fine-tuning guide](https://docs.ray.io/en/master/train/examples/lightning/vicuna_13b_lightning_deepspeed_fine-tune.html) |
| Alpaca | [GitHub](https://github.com/tloen/alpaca-lora/tree/main), [Fine-tuning guide](https://www.mlexpert.io/machine-learning/tutorials/alpaca-fine-tuning) |
| MPT-7B | [GitHub](https://github.com/mosaicml/llm-foundry), [Fine-tuning guide](https://www.youtube.com/watch?v=3de0Utr9XnI), [Documentation](https://huggingface.co/mosaicml/mpt-7b) |
| GPT-J-6B | [GitHub](https://github.com/kingoflolz/mesh-transformer-jax#gpt-j-6b), [Fine-tuning guide 1](https://huggingface.co/docs/transformers/model_doc/gptj), [Fine-tuning guide 2](https://betterprogramming.pub/fine-tuning-gpt-j-6b-on-google-colab-or-equivalent-desktop-or-server-gpu-b6dc849cb205) |
