...
2. Was the presentation effective? Did the group show that they fully internalised the presentation techniques discussed in the Presentation Workshop Videos (PUNCH->WIIFY->Plan)? **(5%)**
3. What are your (original) thoughts? **(5%)**
