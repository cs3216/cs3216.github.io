...
{assignments.seminar.show_updating_notice && <Callout type="warning" emoji="⚠️"> The innovation seminar write-up is currently being updated. Details are tentative and will be finalised soon.</Callout>}
